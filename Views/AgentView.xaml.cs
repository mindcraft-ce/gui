...
namespace mindcraft_ce.Views
{
    ...
    <StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation'
        ...
        <Button x:Name='DeleteButton' Margin='5,0,5,0' Style='{StaticResource DestructiveButtonStyle}'>
            <StackPanel Orientation='Horizontal'>
                ...
                catch (Exception ex)
                {
                    ...
                    Debug.WriteLine($"Failed to load button XAML: {ex.Message}");
                }
            ...
            {
                Debug.WriteLine($"Error populating agent details: {ex}");
            }
        }
        ...
        private Agent GetAgentDetails()
        {
            ...
            {
                Debug.WriteLine($"Error getting agent details: {ex}");
        ...
        private void SaveButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Debug.WriteLine($"Error saving agent: {ex}");
                new ContentDialog
                {
                ...
                Children =
        {
            ...
            if (result == ContentDialogResult.Primary)
            {
                ...
                {
                    Debug.WriteLine($"Error during agent creation: {ex.Message}");
